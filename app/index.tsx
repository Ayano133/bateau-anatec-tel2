...
//         if (response.ok) {
//           console.log('Localisation envoyée avec succès depuis l\'autre téléphone');
//           // Récupérer les coordonnées GPS depuis la réponse
//           const responseData = await response.json();
//           if (responseData && responseData.latitude && responseData.longitude) {
//             console.log('Coordonnées GPS reçues du serveur:', responseData);
//             // Mettre à jour l'état markers avec les coordonnées reçues
//             setMarkers((prevMarkers) => [...prevMarkers, { latitude: responseData.latitude, longitude: responseData.longitude, title: 'Autre Téléphone' }]);
//           } else {
//             console.warn('Coordonnées GPS manquantes dans la réponse du serveur.');
//           }
//         } else {
//           console.error('Erreur lors de l\'envoi de la localisation depuis l\'autre téléphone:', response.status, response.statusText);
//         }
...
//                 title={marker.title || `Position ${index + 1}`}
